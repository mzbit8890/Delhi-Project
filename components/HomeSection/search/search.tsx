...
import { StyledGrid } from "./search.style";
import { NodeNextRequest } from "next/dist/server/base-http/node";
import Searcho from "@../../../components/HomeSection/search/mapp.png"
import People from "@../../../components/HomeSection/search/people.png"
import Calendar from "@../../../components/HomeSection/search/calendar.png"
import Arrow from "@../../../components/HomeSection/search/arrow1.png"
        ...
        >
          <Grid container spacing={1} alignItems="center">
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center" }}>
                {/* <PlaceIcon sx={{ color: "white" }} /> */}
                <Image src={Searcho} alt="" className="w-[20px] h-[20px]" />
                <Box>
                <Typography
    className={`${poppins.variable}`}
    sx={{
      marginLeft: "2px", // Left margin of 36px
      fontFamily: "var(--font-poppins)",
      fontSize: "1rem",
      color: "#FFFFFF", // White text color
      opacity: "0.55", // Opacity set to 55%
    }}
  >
                    Where do you want to go?
                  </Typography>
...
<Divider
  sx={{
    border: "1px solid #FFFFFF80", // White border color with 55% opacity
    height: "43px", // Height of 36px
    marginLeft: "14px", // Left margin of 254px
    marginTop:"6px"
  }}
  orientation="vertical"
/>
            ...
            >
              <Box ml={2.5} sx={{ display: "flex", alignItems: "center" }}>
                {/* <GroupsIcon sx={{ color: "white" }} /> */}
                <Image src={People} alt="" className="w-[20px] h-[20px] ml-3"/>
                <Box>
                  <Typography
                    className={`${poppins.variable}`}
                    sx={{
...
<Divider
  sx={{
    border: "1px solid #FFFFFF80", // White border color with 55% opacity
    height: "43px", // Height of 36px
    marginLeft: "8px", // Left margin of 254px
    marginTop:"6px"
  }}
  orientation="vertical"
/>
            ...
            <Grid item xs={4} sm={1.5} sx={{ ml: { xs: "0rem", lg: "1rem" } }}>
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Image src={Calendar} alt="" className="w-[20px] h-[20px] ml-3"/>
                <Box>
                  <Typography
                    className={`${poppins.variable}`}
                    sx={{
            ...
            >
             <Image src={Arrow} alt="" className="w-[25px] ml-8 mt-4"/>
            </Grid>

            <Grid item xs={4} sm={1.5} sx={{ ml: { xs: "6rem", lg: "28px" } }}>
              <Typography
                className={`${poppins.variable}`}
                sx={{
                  // marginRight: "2rem",
            ...
            <Grid item xs={12} sm={1.5} >
              <Button
                ...
                sx={{
                  ...
                  fontFamily: "var(--font-poppins)",
                  ml: { xs: 0, lg: "15px", },
                  width: { xs: "100%", lg: "115px", die:"100px" },
                  height:"40px",
                  fontWeight:"600px",
              ...
              >
                <Typography sx={{ fontSize: "16px" }}>Lets Go!</Typography>
              </Button>
            </Grid>
          </Grid>
        </Paper>
