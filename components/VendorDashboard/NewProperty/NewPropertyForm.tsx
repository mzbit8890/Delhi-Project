...
import CountiresandCities from "./CountriesAndCityName.json";
import { useSelector } from "react-redux";

export default function NewPropertyFormComponent() {
  ...
  const validateData = (name: any, value: any) => {
  ...
  const handleSubmit = async () => {
    setIsUploading(true);
    const apiUrl = `https://api.hostelbird.com/property/newPropertyVendor/${VendorId}`;
      ...
      <StyledConatiner>
        <StyledBox1>
          ...
          <Input
            ...
            inputProps={{ accept: allowedFileTypes }}
        ...
        <FormControlLabel
          ...
          label="I have read and agreed to Hostel Birds terms and conditions"
        />
        <Button
          sx={{
            display: "flex",
