...
const CurrencySelector = ({ options }: { options: any }) => {
  ...
  return (
    ...
    <button
      ...
      className="flex items-center  border-transparent outline-none"
    >
      <span className="mr-1 font-bold text-[#454545] swt:text-[15px] iwd:text-[13px] wef:text-[11px] cecr:text-[9px]  text-[8px] relative">
        {label} ({symbol})
      ...
      >
        {options.map((option: any) => (
          <button
            ...
            className="w-[75px] px-2 py-2  text-left wef:text-[11px] cecr:text-[9px] text-[8px] hover:bg-gray-100 focus:bg-gray-100 flex items-center gap-1"
          >
